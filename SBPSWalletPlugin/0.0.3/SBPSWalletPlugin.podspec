...
Opentech Hibrid Framework plug-in
  ...
  s.source           = { :git => 'git@github.com:openpaysendcorner/openpaysendcorner_ios_artifacts.git', :tag => s.version.to_s }
  ...
  s.dependency 'OTHFOTML' , '0.0.3' 
  s.dependency 'OTHFOTMLModels', '0.0.3' 
  s.dependency 'OTHFOTMLCore', '0.0.3'

  s.dependency 'OTMLReCaptchaAddon', '0.0.3' 
  s.dependency 'OTMLMTokenAddon', '0.0.3' 
  s.dependency 'OTMLCardReaderAddon', '0.0.3' 
  s.dependency 'OTMLApplePayAddon', '0.0.3' 
  s.dependency 'OTBarCodeAddon', '0.0.3' 
end
