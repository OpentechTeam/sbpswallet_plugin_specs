...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTMLReCaptchaAddon', '0.0.8' 
  s.dependency 'OTMLMTokenAddon', '0.0.8' 
  s.dependency 'OTMLCardReaderAddon', '0.0.8' 
  s.dependency 'OTMLApplePayAddon', '0.0.8' 
  s.dependency 'OTBarCodeAddon', '0.0.8' 
end
