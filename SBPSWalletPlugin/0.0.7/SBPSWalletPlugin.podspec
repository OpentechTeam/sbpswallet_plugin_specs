...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTMLReCaptchaAddon', '0.0.7' 
  s.dependency 'OTMLMTokenAddon', '0.0.7' 
  s.dependency 'OTMLCardReaderAddon', '0.0.7' 
  s.dependency 'OTMLApplePayAddon', '0.0.7' 
  s.dependency 'OTBarCodeAddon', '0.0.7' 
end
