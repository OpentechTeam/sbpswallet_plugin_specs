...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTHFOTMLCore', '0.0.5'

  s.dependency 'OTMLReCaptchaAddon', '0.0.5' 
  s.dependency 'OTMLMTokenAddon', '0.0.5' 
  s.dependency 'OTMLCardReaderAddon', '0.0.5' 
  s.dependency 'OTMLApplePayAddon', '0.0.5' 
  s.dependency 'OTBarCodeAddon', '0.0.5' 
end
