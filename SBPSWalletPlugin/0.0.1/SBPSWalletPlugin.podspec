...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTHFOTML' , '0.0.1' 
  s.dependency 'OTHFOTMLModels', '0.0.1' 
  s.dependency 'OTHFOTMLCore', '0.0.1'

  s.dependency 'OTMLReCaptchaAddon', '0.0.1' 
  s.dependency 'OTMLMTokenAddon', '0.0.1' 
  s.dependency 'OTMLCardReaderAddon', '0.0.1' 
  s.dependency 'OTMLApplePayAddon', '0.0.1' 
  s.dependency 'OTBarCodeAddon', '0.0.1' 
end
