...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTMLReCaptchaAddon', '0.0.6' 
  s.dependency 'OTMLMTokenAddon', '0.0.6' 
  s.dependency 'OTMLCardReaderAddon', '0.0.6' 
  s.dependency 'OTMLApplePayAddon', '0.0.6' 
  s.dependency 'OTBarCodeAddon', '0.0.6' 
end
