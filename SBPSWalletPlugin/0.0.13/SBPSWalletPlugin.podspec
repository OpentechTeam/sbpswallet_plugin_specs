...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTMLReCaptchaAddon', '0.0.13' 
  s.dependency 'OTMLMTokenAddon', '0.0.13' 
  s.dependency 'OTMLCardReaderAddon', '0.0.13' 
  s.dependency 'OTMLApplePayAddon', '0.0.13' 
  s.dependency 'OTBarCodeAddon', '0.0.13' 
