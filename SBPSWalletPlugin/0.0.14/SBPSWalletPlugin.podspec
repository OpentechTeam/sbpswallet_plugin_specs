...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTHFOTML' , '0.0.14' 
  s.dependency 'OTHFOTMLModels', '0.0.14' 
  s.dependency 'OTHFOTMLCore', '0.0.14'

  s.dependency 'OTMLReCaptchaAddon', '0.0.14' 
  s.dependency 'OTMLMTokenAddon', '0.0.14' 
  s.dependency 'OTMLCardReaderAddon', '0.0.14' 
  s.dependency 'OTMLApplePayAddon', '0.0.14' 
  s.dependency 'OTBarCodeAddon', '0.0.14' 
  s.dependency 'IDnowSDK', '9.7.3'
