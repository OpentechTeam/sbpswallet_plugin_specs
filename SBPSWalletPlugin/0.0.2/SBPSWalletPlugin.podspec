...
Opentech Hibrid Framework plug-in
  ...
  s.dependency 'OTHFOTML' , '0.0.2' 
  s.dependency 'OTHFOTMLModels', '0.0.2' 
  s.dependency 'OTHFOTMLCore', '0.0.2'

  s.dependency 'OTMLReCaptchaAddon', '0.0.2' 
  s.dependency 'OTMLMTokenAddon', '0.0.2' 
  s.dependency 'OTMLCardReaderAddon', '0.0.2' 
  s.dependency 'OTMLApplePayAddon', '0.0.2' 
  s.dependency 'OTBarCodeAddon', '0.0.2' 
end
